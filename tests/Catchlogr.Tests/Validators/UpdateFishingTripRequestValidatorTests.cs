...
namespace Catchlogr.Tests.Validators;

public class UpdateFishingTripRequestValidatorTests
{
    private readonly UpdateFishingTripRequestValidator _validator = new();

    private static UpdateFishingTripRequest ValidRequest() => new(
