...
public class UpdateCatchRequestValidatorTests
{
    private readonly UpdateCatchRequestValidator _validator = new();

    private static UpdateCatchRequest ValidRequest() => new(
        Species: "Perch",
        Length: 45,
        Weight: 800,
        PhotoUrl: null,
