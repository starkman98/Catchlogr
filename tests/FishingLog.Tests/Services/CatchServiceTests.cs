...
public class CatchServiceTests
{
    ...
    public CatchServiceTests()
    {
        ...
        _sut = new CatchService(_repo, _tripRepo);
    }
    ...
    public async Task GetAllAsync_Should_Return_Mapped_Response()
    {
        ...
        _repo.GetAllAsync(TestContext.Current.CancellationToken).Returns(catches);
    ...
    public async Task GetByIdAsync_Should_Return_Response_When_Trip_Exists()
    {
        ...
        _repo.GetByIdAsync(id, TestContext.Current.CancellationToken).Returns(fakeCatch);
    ...
    {
        await _repo.GetByIdAsync(Arg.Any<Guid>(), TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync_Should_Return_Response_With_New_Id()
    {
        ...
        _tripRepo.GetByIdAsync(tripId, TestContext.Current.CancellationToken).Returns(trip);
    ...
    {
        _tripRepo.GetByIdAsync(Arg.Any<Guid>(), TestContext.Current.CancellationToken).ReturnsNull();
    ...
    public async Task UpdateAsync_Should_Update_And_Return_Response()
    {
        ...
        _repo.GetByIdAsync(id, TestContext.Current.CancellationToken).Returns(updateCatch);
    ...
    public async Task DeleteAsync_Should_Delete_When_Catch_Exists()
    {
        ...
        _repo.GetByIdAsync(id, TestContext.Current.CancellationToken).Returns(deleteCatch);

        await _sut.DeleteAsync(id, TestContext.Current.CancellationToken);

        await _repo.Received(1).DeleteAsync(Arg.Any<Guid>(), TestContext.Current.CancellationToken);
    }

    [Fact]
    public async Task DeleteAsync_Should_Throw_When_Catch_Not_Found()
    {
        _repo.GetByIdAsync(Arg.Any<Guid>(), TestContext.Current.CancellationToken).ReturnsNull();
    ...
    public async Task GetByTripIdAsync_Should_Return_Mapped_Response()
    {
        ...
        _repo.GetByTripIdAsync(tripId, TestContext.Current.CancellationToken).Returns(catches);
